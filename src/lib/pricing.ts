...
export type Plan = "essential" | "timeless" | "premier";
...
export const pricingMatrix = {
  essential: { USD: 4900, AUD: 7400, GBP: 3900, EUR: 4500, CAD: 6600, NZD: 7900 },
  timeless: { USD: 7900, AUD: 11900, GBP: 6300, EUR: 7200, CAD: 10600, NZD: 12700 },
  premier: { USD: 13900, AUD: 20900, GBP: 11100, EUR: 12700, CAD: 18600, NZD: 22400 },
};
...
export function isPlanUpgrade(fromPlan: string, toPlan: Plan): boolean {
  const planHierarchy = ['free_trial', 'essential', 'timeless', 'premier'];
...
export function getAvailableUpgrades(currentPlan: string): Plan[] {
  const planHierarchy: (string | Plan)[] = ['free_trial', 'essential', 'timeless', 'premier'];
